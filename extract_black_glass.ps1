$zipPath = "C:\Users\KIRAN STEEL\Desktop\Stainless Steel Compound\WhatsApp Unknown 2026-07-10 at 8.06.22 PM.zip"
$tempDir = "temp_black_glass_extract"
...
foreach ($file in $files) {
    $ext = $file.Extension
    $newName = "ss-black-glass-railing-$i$ext"
