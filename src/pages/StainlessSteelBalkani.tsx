    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <main className="flex-grow pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100">
          <h1 className="text-4xl md:text-5xl font-rozha text-primary mb-6">Stainless Steel Balkani</h1>
          <div className="prose prose-slate max-w-none">
            <p className="text-lg text-slate-700 leading-relaxed mb-8">
              Beautiful stainless steel balcony designs and grills for residential safety and aesthetics.
            </p>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 mt-8">
              ...
              <p className="text-slate-600 mb-4">Interested in our Stainless Steel Balkani? Contact us today for a customized quote.</p>
